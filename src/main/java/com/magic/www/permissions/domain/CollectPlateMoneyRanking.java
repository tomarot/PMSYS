...
public class CollectPlateMoneyRanking extends QueryParameter{
    private Integer id;
    ...
    private String inflowStockCode;

    private String inflowStockName;
    ...
    public String getInflowStockCode() {
        return inflowStockCode;
    }

    public void setInflowStockCode(String inflowStockCode) {
        this.inflowStockCode = inflowStockCode == null ? null : inflowStockCode.trim();
    }

    public String getInflowStockName() {
        return inflowStockName;
    }

    public void setInflowStockName(String inflowStockName) {
        this.inflowStockName = inflowStockName == null ? null : inflowStockName.trim();
    }
